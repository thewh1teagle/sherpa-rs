...
fn main() {
    let config = KittenTtsConfig {
        model: "./kitten-nano-en-v0_1-fp16/model.fp16.onnx".to_string(),
        voices: "./kitten-nano-en-v0_1-fp16/voices.bin".into(),
        tokens: "./kitten-nano-en-v0_1-fp16/tokens.txt".into(),
        data_dir: "./kitten-nano-en-v0_1-fp16/espeak-ng-data".into(),
        length_scale: 1.0,
        ..Default::default()
    };
